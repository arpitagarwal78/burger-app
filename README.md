...
## MY APP LOGIC
go to config webpack.config and search for css-loader / style-loader
add so that we can limit the scope of css file within a file as
{
            test: /\.css$/,
            use: [
...
PASTE IN BOTH CONFIG WEBPACK FILES

remove logo.svc file in src folder and remove import from App.js file 
